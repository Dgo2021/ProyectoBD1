...
create table PERSONA (
   ...
   identificacion      VARCHAR2(13)           not null,
   nit                 VARCHAR2(10)         ,
...
create table SERVICIO (
   ...
   constraint FK_SERVICIO_CLINICA foreign key (idclinica) references CLINICA(idclinica),
...
create table EMPLEADO_SERVICIOS (
   idempleadosevicios   NUMBER(10)            GENERATED by default on null as IDENTITY,
   idempleado           NUMBER(10)            NOT NULL,
   idclinica            NUMBER(10)            NOT NULL,
   idarea               NUMBER(10)            NOT NULL,
   idservicio           NUMBER(10)            NOT NULL,
   constraint PK_EMPLEADO_SERVICIOS primary key (idempleadosevicios),
...
create table AGENDA (
   ...
   CONSTRAINT CK_HORA Check (hora_ingreso between 8 and 17  )
);
