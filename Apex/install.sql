...
@@application/shared_components/user_interface/lovs/area.sql
@@application/shared_components/user_interface/lovs/cliente.sql
@@application/shared_components/user_interface/lovs/cliente02.sql
@@application/shared_components/user_interface/lovs/clínica.sql
@@application/shared_components/user_interface/lovs/departamento.sql
@@application/shared_components/user_interface/lovs/email_username_format.sql
@@application/shared_components/user_interface/lovs/empleado.sql
@@application/shared_components/user_interface/lovs/estado_agenda.sql
@@application/shared_components/user_interface/lovs/genero.sql
@@application/shared_components/user_interface/lovs/login_remember_username.sql
@@application/shared_components/user_interface/lovs/nombre_cliente_agenda.sql
@@application/shared_components/user_interface/lovs/persona.sql
@@application/shared_components/user_interface/lovs/rol.sql
@@application/shared_components/user_interface/lovs/servicio.sql
...
@@application/shared_components/security/authentications/cuentas_de_application_express.sql
