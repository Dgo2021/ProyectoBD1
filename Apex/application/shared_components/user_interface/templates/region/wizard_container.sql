...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600392424609395601)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600392759935395601)
,p_plug_template_id=>wwv_flow_api.id(5600392424609395601)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600393077981395601)
,p_plug_template_id=>wwv_flow_api.id(5600392424609395601)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600393376254395601)
,p_plug_template_id=>wwv_flow_api.id(5600392424609395601)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600393618274395601)
,p_plug_template_id=>wwv_flow_api.id(5600392424609395601)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600393981710395601)
,p_plug_template_id=>wwv_flow_api.id(5600392424609395601)
