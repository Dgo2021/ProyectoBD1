...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600371244069395593)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600371542638395593)
,p_plug_template_id=>wwv_flow_api.id(5600371244069395593)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600371867386395593)
,p_plug_template_id=>wwv_flow_api.id(5600371244069395593)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600372158798395593)
,p_plug_template_id=>wwv_flow_api.id(5600371244069395593)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600372492868395594)
,p_plug_template_id=>wwv_flow_api.id(5600371244069395593)
,p_name=>'Sub Regions'
