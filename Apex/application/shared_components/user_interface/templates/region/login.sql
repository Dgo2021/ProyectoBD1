...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600373004355395594)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600373311240395594)
,p_plug_template_id=>wwv_flow_api.id(5600373004355395594)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600373676478395594)
,p_plug_template_id=>wwv_flow_api.id(5600373004355395594)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600373969224395594)
,p_plug_template_id=>wwv_flow_api.id(5600373004355395594)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600374227194395594)
,p_plug_template_id=>wwv_flow_api.id(5600373004355395594)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600374525577395594)
,p_plug_template_id=>wwv_flow_api.id(5600373004355395594)
,p_name=>'Sub Regions'
