...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600385067041395598)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600385368592395598)
,p_plug_template_id=>wwv_flow_api.id(5600385067041395598)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600385644147395598)
,p_plug_template_id=>wwv_flow_api.id(5600385067041395598)
,p_name=>'Tabs'
