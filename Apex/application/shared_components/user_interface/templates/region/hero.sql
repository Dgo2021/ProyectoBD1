...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600353468248395586)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600353751077395587)
,p_plug_template_id=>wwv_flow_api.id(5600353468248395586)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600354072007395587)
,p_plug_template_id=>wwv_flow_api.id(5600353468248395586)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600354317907395587)
,p_plug_template_id=>wwv_flow_api.id(5600353468248395586)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600354637796395587)
,p_plug_template_id=>wwv_flow_api.id(5600353468248395586)
,p_name=>'Sub Regions'
