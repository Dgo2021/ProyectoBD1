...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600349296018395585)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600349582532395585)
,p_plug_template_id=>wwv_flow_api.id(5600349296018395585)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600349863482395585)
,p_plug_template_id=>wwv_flow_api.id(5600349296018395585)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600350117388395585)
,p_plug_template_id=>wwv_flow_api.id(5600349296018395585)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600350452691395585)
,p_plug_template_id=>wwv_flow_api.id(5600349296018395585)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600350787024395585)
,p_plug_template_id=>wwv_flow_api.id(5600349296018395585)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600351017355395586)
,p_plug_template_id=>wwv_flow_api.id(5600349296018395585)
,p_name=>'Sub Regions'
