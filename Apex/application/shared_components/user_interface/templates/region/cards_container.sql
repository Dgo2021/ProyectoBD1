...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5600328243338395578)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600328507940395578)
,p_plug_template_id=>wwv_flow_api.id(5600328243338395578)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(5600328829913395578)
,p_plug_template_id=>wwv_flow_api.id(5600328243338395578)
,p_name=>'Sub Regions'
